...
struct Widgets {
    ...
    personal_tag_filter_box: gtk::Box,
    all_tag_filter: gtk::CheckButton,
...
impl Widgets {
    fn clone_refs(&self) -> Rc<Self> {
        Rc::new(Self {
            ...
            personal_tag_filter_box: self.personal_tag_filter_box.clone(),
            all_tag_filter: self.all_tag_filter.clone(),
